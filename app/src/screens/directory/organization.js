...
class organization extends Component {
    ...
    componentDidMount() {
        fetch(this.props.host+'api/organizations', {
            method: 'GET',
            headers: {
        ...
        return (
            <View style={styles.container}>
                <FlatList
                    ...
                    renderItem={({ item }) =>  <View style={styles.flatList}>
                        <View style={{flex:5}}>
                            ...
                            <Text style={{color:'#9a9a9a'}}>Contact:{item.admin_contact}</Text>
                        </View>
                        <View style={{flex:1}}>
                            <Icon name="phone"
                                  onPress={()=>{Linking.openURL(`tel:${item.admin_contact}`)}}
                ...
                <View style={styles.switchButton}>
                    ...
                    <TouchableOpacity
                        onPress={()=>{this.props.navigation.navigate("BloodBank")}}
                        style={styles.oppa}>
                        <Text style={{color:'#eee',fontWeight:"bold"}}>
                            Blood Bank
                        </Text>
