...
class addbloodbank extends Component {
    state = { name: '',address:'',contact_number:'',organizations:[],organization:'',countries:[],country:'',zillas:[],zilla:'',serviceItema:[]};
    onButtonPress(){
        console.log(this.state);
        const host = this.props.host;
        return fetch(host+'api/blood/bank',{
            method: 'POST',
            headers: {
            ...
            .then((response) => ToastAndroid.showWithGravityAndOffset(
                ...
                this.setState({ name: '',address:'',contact_number:'',organizations:[],organization:'',countries:[],country:'',zillas:[],zilla:'',serviceItema:[]}))
            .catch((error) => {
                console.error(error);
            });
    };
